...
float lightPosition0[] = {-2, 0, 0, 1};

float lightAmbient1[] = {0, 0, 0, 1};
float lightDiffuse1[] = {0, 0, 1, 1};
float lightSpecular1[] = {0, 0, 1, 1};
float lightPosition1[] = {2, 0, 0, 1};
...
void display(void)
{
    ...
    glBegin(GL_TRIANGLES);
        // front face
        glNormal3f(0, 0.447214f, 0.894428f);
		glVertex3f(0.0f, 1.0f, 0.0f);
		glVertex3f(-1.0f, -1.0f, 1.0f);
		glVertex3f(1.0f, -1.0f, 1.0f);

        // right face
        glNormal3f(0.894428f, 0.447214f, 0);
		glVertex3f(0.0f, 1.0f, 0.0f);
		glVertex3f(1.0f, -1.0f, 1.0f);
		glVertex3f(1.0f, -1.0f, -1.0f);
...
int initialize(void)
{
    ...
    glClearDepth(1.0f);
    glEnable(GL_DEPTH_TEST);                    // depth test enabled (one of the 8 test)
    glDepthFunc(GL_LEQUAL);                     // pass those fragments whose value <= glClearDepth
