...
float materialDiffuse[] = {0.5f, 0.2f, 0.7f, 1};
float materialSpecular[] = {0.7f, 0.7f, 0.7f, 1};
...
int initialize(void)
{
    ...
    glMaterialfv(GL_FRONT, GL_AMBIENT, materialAmbient);        // gl_front_and_back if animation
