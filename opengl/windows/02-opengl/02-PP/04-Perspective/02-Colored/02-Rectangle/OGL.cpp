...
int initialize(void)
{
    ...
    // color                                (no vbo_color needed when only one color is needed for whole shape)
    //                                      (use glVertexAttrib3f(AMC_ATTRIBUTE_COLOR, 0, 0, 1) )
    ...
    glBindBuffer(GL_ARRAY_BUFFER, 0);
    //glVertexAttrib3f(AMC_ATTRIBUTE_COLOR, 0, 0, 1);
