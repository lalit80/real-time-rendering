...
public class GLESView extends GLSurfaceView implements OnGestureListener, OnDoubleTapListener, GLSurfaceView.Renderer {
    ...
    private int ibo_position[] = new int[1];
    ...
    private int inititalize(GL10 gl) {
        ...
        final int rectangle_indices[] = new int[] {
                                                0, 1, 2,
                                                2, 3, 0
                                            };
        ...
        GLES32.glGenBuffers(1, ibo_position, 0);
        GLES32.glBindBuffer(GLES32.GL_ELEMENT_ARRAY_BUFFER, ibo_position[0]);
        byteBuffer = ByteBuffer.allocateDirect(rectangle_indices.length * 4);
        byteBuffer.order(ByteOrder.nativeOrder());
        IntBuffer indicesBuffer = byteBuffer.asIntBuffer();
        indicesBuffer.put(rectangle_indices);
        indicesBuffer.position(0);
        GLES32.glBufferData(GLES32.GL_ELEMENT_ARRAY_BUFFER, (rectangle_indices.length * 4), indicesBuffer, GLES32.GL_STATIC_DRAW);
