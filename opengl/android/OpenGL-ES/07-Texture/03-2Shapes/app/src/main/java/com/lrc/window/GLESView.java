...
public class GLESView extends GLSurfaceView implements OnGestureListener, OnDoubleTapListener, GLSurfaceView.Renderer {
    ...
    private int inititalize(GL10 gl) {
        ...
        texStone[0] = loadGLTexture(R.raw.stone);
    ...
    private void display() {
        ...
        Matrix.multiplyMM(modelViewMatrix, 0, translationMatrix, 0, rotationMatrix, 0);         // mv = t * r
        ...
        Matrix.setIdentityM(rotationMatrix, 0);
        Matrix.translateM(translationMatrix, 0, 1.5f, 0.0f, -5.0f);
        Matrix.setRotateM(rotationMatrix, 0, angleRectangle, 0.0f, 1.0f, 0.0f);
        Matrix.multiplyMM(modelViewMatrix, 0, translationMatrix, 0, rotationMatrix, 0);         // mv = t * r
        Matrix.multiplyMM(modelViewProjectionMatrix, 0, perspectiveProjectionMatrix, 0, modelViewMatrix, 0);
        ...
        GLES32.glActiveTexture(GLES32.GL_TEXTURE0);
        GLES32.glBindTexture(GLES32.GL_TEXTURE_2D, texKundli[0]);
        GLES32.glUniform1i(textureSamplerUniform, 0);
        // bind with vao_triangle
        GLES32.glBindVertexArray(vao_rectangle[0]);
