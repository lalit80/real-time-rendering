...
public class GLESView extends GLSurfaceView implements OnGestureListener, OnDoubleTapListener, GLSurfaceView.Renderer {
    ...
    private int inititalize(GL10 gl) {
        ...
        triangleColorBuffer.put(triangle_normal);
        triangleColorBuffer.position(0);
        GLES32.glBufferData(GLES32.GL_ARRAY_BUFFER, (triangle_normal.length * 4), triangleColorBuffer, GLES32.GL_STATIC_DRAW);
        ...
        light[0].position[2] = 2.0f;
        light[0].position[3] = 1.0f;

        material[0].diffuse[0] = 0.4f;
        material[0].diffuse[1] = 0.4f;
        material[0].diffuse[2] = 0.4f;
