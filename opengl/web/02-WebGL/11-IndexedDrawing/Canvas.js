...
function initialize() {
    ...
    var rectangle_indices = new Uint32Array([
        0, 1, 2,
        2, 3, 0
    ]);
    ...
    ibo_position = gl.createBuffer();
    gl.bindBuffer(gl.ELEMENT_ARRAY_BUFFER, ibo_position);
...
function display() {
    ...
    mat4.multiply(modelViewProjectionMatrix, perspectiveProjectionMatrix, translationMatrix);
