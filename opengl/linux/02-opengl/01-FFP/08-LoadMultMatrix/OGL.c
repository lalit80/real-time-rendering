...
void display(void)
{
    ...
    angleCube = angleCube * (M_PI / 180.0f);
    ...
    rotationMatrixX[3] = 0;
    rotationMatrixX[4] = 0;
    rotationMatrixX[5] = cos(angleCube);
    rotationMatrixX[6] = sin(angleCube);
    rotationMatrixX[7] = 0;
    rotationMatrixX[8] = 0;
    rotationMatrixX[9] = -sin(angleCube);
    rotationMatrixX[10] = cos(angleCube);
    rotationMatrixX[11] = 0;
    rotationMatrixX[12] = 0;
    rotationMatrixX[13] = 0;
    rotationMatrixX[14] = 0;
    rotationMatrixX[15] = 1.0f;

    glMultMatrixf(rotationMatrixX);

    // Y rotation matrix
    rotationMatrixY[0] = cos(angleCube);
    rotationMatrixY[1] = 0;
    rotationMatrixY[2] = -sin(angleCube);
    rotationMatrixY[3] = 0;
    rotationMatrixY[4] = 0;
    rotationMatrixY[5] = 1.0f;
    rotationMatrixY[6] = 0;
    rotationMatrixY[7] = 0;
    rotationMatrixY[8] = sin(angleCube);
    rotationMatrixY[9] = 0;
    rotationMatrixY[10] = cos(angleCube);
    rotationMatrixY[11] = 0;
    rotationMatrixY[12] = 0;
    rotationMatrixY[13] = 0;
    rotationMatrixY[14] = 0;
    rotationMatrixY[15] = 1.0f;

    glMultMatrixf(rotationMatrixY);

    // Z rotation matrix
    rotationMatrixZ[0] = cos(angleCube);
    rotationMatrixZ[1] = sin(angleCube);
    rotationMatrixZ[2] = 0;
    rotationMatrixZ[3] = 0;
    rotationMatrixZ[4] = -sin(angleCube);
    rotationMatrixZ[5] = cos(angleCube);
    rotationMatrixZ[6] = 0;
    rotationMatrixZ[7] = 0;
    rotationMatrixZ[8] = 0;
    rotationMatrixZ[9] = 0;
    rotationMatrixZ[10] = 1.0f;
    rotationMatrixZ[11] = 0;
    rotationMatrixZ[12] = 0;
    rotationMatrixZ[13] = 0;
    rotationMatrixZ[14] = 0;
