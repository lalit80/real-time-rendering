...
HRESULT initialize(void)
{
   ...
   D3D11_INPUT_ELEMENT_DESC d3d11InputElementDesc[2];
    ...
    const float pyramidVertices[] = {
        ...
        1.0f, -1.0f,  1.0f, // front-right (Swapped with left)
        -1.0f, -1.0f,  1.0f, // front-left

        // right
        0.0f,  1.0f,  0.0f, // right-top
        1.0f, -1.0f, -1.0f, // right-right (Swapped with left)
        1.0f, -1.0f,  1.0f, // right-left

        // back
        0.0f,  1.0f,  0.0f, // back-top
        -1.0f, -1.0f, -1.0f, // back-right (Swapped with left)
        1.0f, -1.0f, -1.0f, // back-left

        // left
        0.0f,  1.0f,  0.0f, // left-top
        -1.0f, -1.0f,  1.0f, // left-right (Swapped with left)
