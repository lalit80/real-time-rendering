...
HRESULT initialize(void)
{
    ...
    hr = loadD3DTexture(L"Smiley.bmp", &gpID3D11ShaderResourceView_CubeTexture);
    if(FAILED(hr)) {
        gpFile = fopen(gszLogFileName, "a+");
        fprintf(gpFile, "loadD3DTexture() failed for Smiley.bmp\n");
        fclose(gpFile);
        return hr;
    }
...
void display(void)
{
    ...
    if (keyPress == 1) {
        ...
        cubeTexCoords[8]  = 0.5f;
        cubeTexCoords[9]  = 0.5f;
        cubeTexCoords[10] = 0.5f;
        cubeTexCoords[11] = 0.0f;
    } 
    else if (keyPress == 2) {
        cubeTexCoords[0]  = 0.0f;
        cubeTexCoords[1]  = 2.0f; 
        cubeTexCoords[2]  = 2.0f;
        ...
        cubeTexCoords[6]  = 0.0f;
        cubeTexCoords[7]  = 0.0f; 
        cubeTexCoords[8]  = 2.0f;
        cubeTexCoords[9]  = 2.0f; 
        cubeTexCoords[10] = 2.0f;
        cubeTexCoords[11] = 0.0f; 
    } 
    else if (keyPress == 3) {
        cubeTexCoords[0]  = 0.0f;
        cubeTexCoords[1]  = 1.0f; 
        cubeTexCoords[2]  = 1.0f;
        ...
        cubeTexCoords[6]  = 0.0f;
        cubeTexCoords[7]  = 0.0f; 
        cubeTexCoords[8]  = 1.0f;
        cubeTexCoords[9]  = 1.0f; 
        cubeTexCoords[10] = 1.0f;
        cubeTexCoords[11] = 0.0f; 
    } 
    else {
        ...
        cubeTexCoords[9]  = 0.5f; 
        cubeTexCoords[10] = 0.5f;
        cubeTexCoords[11] = 0.5f; 
    }
   
    // texture buffer is dynamic, so we need to map and copy data and then unmap
    gpID3D11DeviceContext->UpdateSubresource(
        gpID3D11Buffer_Cube_TexCoordBuffer,
        0,
        NULL,
        cubeTexCoords,
        0,
